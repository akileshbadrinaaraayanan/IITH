...
set title "RSRP for UE at different speeds combined"
...
plot "sinr_20_1_final.txt" using 1:2 title "RSRP for UE 1 at speed 20 m/s (dBm)", \
     "sinr_50_20_final.txt" using 1:2 title "RSRP for UE 20 at speed 50 m/s (dBm)", \
     "sinr_100_17_final.txt" using 1:2 title "RSRP for UE 17 at speed 100 m/s (dBm)"
