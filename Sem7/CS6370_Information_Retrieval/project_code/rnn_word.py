...
from lstm import *
from encoder_word import *
from encoder_sent import *
from decoder_sent import *
from decoder_word import *
from updates import *

class RNN(object):
    def __init__(self, in_size, out_size, hidden_size,
                 cell = "lstm", optimizer = "rmsprop", p = 0.5, num_sents = 1):
    ...
    def define_layers(self):
        ...
        layer_input = T.reshape(layer_input[layer_input.shape[0] - 1], (1, self.batch_size * word_encoder_layer.hidden_size))
        ...
        #sents_codes = sent_decs
        #sents_codes = T.reshape(sents_codes, (1, self.batch_size * sent_decoder_layer.out_size))

        # word decoder
        word_decoder_layer = WordDecoderLayer(self.cell, rng, str(i + 4), (word_encoder_layer.hidden_size, self.out_size),
                                         layer_input, self.mask, self.is_train, self.batch_size, self.drop_rate)
